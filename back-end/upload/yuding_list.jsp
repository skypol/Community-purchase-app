					...
					<table class="result-tab" width="100%">
						...
						<c:forEach var="x" items="${list}" varStatus="status">
							...
							<tr>
								...
								<td>${x.pj}</td>
								<td>${x.state}</td>
								<td><a href="${pageContext.request.contextPath}/news/upddstate?dingdan.id=${x.id}&dingdan.state=接受&type=1">接受</a>||<a href="${pageContext.request.contextPath}/news/upddstate?dingdan.id=${x.id}&dingdan.state=拒绝&type=1">拒绝</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
